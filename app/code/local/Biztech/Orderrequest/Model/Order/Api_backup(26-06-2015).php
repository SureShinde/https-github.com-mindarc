 ...
 */
class Biztech_Orderrequest_Model_Order_Api extends Mage_Sales_Model_Api_Resource
{
    /**
    ...
    {        
        ...
        */
        ...
        foreach ($_history as $_historyItem){
            $result['shipping_address']['customer_comments'][$comment_index]['comment'] = strip_tags(str_replace('Customer Order Comment','',$_historyItem->getComment()));
            $result['shipping_address']['customer_comments'][$comment_index]['create_at'] = $_historyItem->getCreatedAt();
            $comment_index++;
        }
        /* ends */
